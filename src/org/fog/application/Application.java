...
import org.fog.entities.CryptographyConfig;
...
public class Application {
	 ...
	 */
	CryptographyConfig cyrptographyConfig;
	public CryptographyConfig getCyrptographyConfig(){
		return cyrptographyConfig;
	}

	public void setCyrptographyConfig(CryptographyConfig config){
		this.cyrptographyConfig = config;
	}
	/*
	Code End
	 */
				...
				if(selectivityModel.canSelect()){
					...
					if(edge.getEdgeType() == AppEdge.ACTUATOR){
						//for(Integer actuatorId : module.getActuatorSubscriptions().get(edge.getTupleType())){
							...
							tuple.setDataPacket(inputTuple.getDataPacket());
							tuple.setKeyExchangeLocation(tuple.getKeyExchangeLocation());
							tuples.add(tuple);
