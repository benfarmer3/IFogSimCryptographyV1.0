...
public class Tuple extends Cloudlet{
	...
	added location of key request
	 */
	private CommunicatedDevice keyLocation;
	/*
	code end
	 */
	...
	/*
	Code added by : Ben Farmer
	Adding data value for the tuple
	 */
	...
	public void setKeyExchangeLocation(CommunicatedDevice keyLocation){
		this.keyLocation = keyLocation;
	}
	public CommunicatedDevice getKeyExchangeLocation(){
		return this.keyLocation;
	}

	/*
	Code by Ben Farmer finishes here
	*/
