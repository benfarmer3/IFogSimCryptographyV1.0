...
*/				moduleMapping.addModuleToDevice("connector", "cloud"); // fixing all instances of the Connector module to the Cloud
			...
			CryptographyConfig.create(true, EncryptionType.AES,CommunicatedDevice.ENDPOINT,CommunicatedDevice.CLOUD, KeyExchangeTypes.STOREDSYMMETRIC);
